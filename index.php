          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-4 col-sm-5">
                         <p>Kinclongkan kendaraan anda bersama Yuki Wash</p>
                    </div>

                    <div class="col-md-8 col-sm-7 text-align-right">
                         <span class="phone-icon"><i class="fa fa-phone"></i> 081224315313</span>
               ...
               <div class="row">
                         ...
                         <div class="owl-carousel owl-theme">
                              <div class="item item-first">
                                   <div class="caption">
                                        <div class="col-md-offset-1 col-md-10">
                                             <h3>Percayakan Noda Kendaraan Dengan Jasa Kami</h3>
                                             <h1>Yuki Wash</h1>
                              ...
                              <div class="item item-second">
                                   <div class="caption">
                                        <div class="col-md-offset-1 col-md-10">
                                             <h3>Kinclongkan kendaraan anda hanya di Yuki Wash</h3>
                                             <h1>Yuki Wash</h1>
                                             <a href="#appointment" class="section-btn btn btn-default btn-gray smoothScroll">Booking Sekarang</a>
                                        </div>
                                   </div>
                              </div>
                              ...
                              <div class="item item-third">
                                   <div class="caption">
                                        <div class="col-md-offset-1 col-md-10">
                                             ...
                                             <h1>Kepuasan Anda Adalah Semangat Bagi Kami</h1>
                    ...
                    <div class="col-md-6 col-sm-6">
                         <div class="about-info">
                              ...
                              <div class="wow fadeInUp" data-wow-delay="0.8s">
                                   <p>Yuki Wash menyediakan berbagai jenis pelayanan untuk anda</p>
                              </div>
                              <figure class="profile wow fadeInUp" data-wow-delay="1s">
                                   <figcaption>
                                        <h3>Steam Mobil Standart</h3>
                                        <h5>Fasilitas yang di dapatkan : </h5>
                                        <h5>1. Steam Sabun Biasa <br>
                                            2. Tambah Angin </h5>
                                   </figcaption>
                              </figure>
                              <figure class="profile wow fadeInUp" data-wow-delay="1s">
                                   <figcaption>
                                        <h3>Steam Motor</h3>
                                        <h5>Fasilitas yang di dapatkan : </h5>
                                        <h5>1. Steam Sabun Salju <br>
                                            2. Tambah Angin </h5>
                                   </figcaption>
                              </figure>
                              <figure class="profile wow fadeInUp" data-wow-delay="1s">
                                   <figcaption>
                                        <h3>Steam Mobil Premium</h3>
                                        <h5>Fasilitas yang di dapatkan : </h5>
                                        <h5>1. Steam Sabun Slaju<br>
                                            2. Cuci Dalam<br> 
                                            3. Tambah Angin</h5>
                                   </figcaption>
                              </figure>
                    ...
                    <div class="col-md-12 col-sm-12">
                         ...
                         <form id="appointment-form" role="form" method="post" action="pages/proses_pendaftaran.php">
                              ...
                              <div class="wow fadeInUp" data-wow-delay="0.8s">
                                   ...
                                   <div class="col-md-6 col-sm-6">
                                        <label for="email">No. Plat Kendaraan</label>
                                        <input type="text" class="form-control" id="email" name="nomor_platkendaraan" placeholder="No. Plat Kendaraan Anda" required="">
                                   </div>
...
?>
                                   ...
                                   <div class="col-md-6 col-sm-6">
                                        <label for="select">Jenis Pencucian</label>
                                        <?php
...
?>
                                   ...
                                   <div class="col-md-6 col-sm-6">
                                        <label for="email">Tanggal Pencucian</label>
                                        <input type="date" class="form-control" id="email" name="tgl_pencucian" value="<?=$tgl_pencucian;?>" readonly>
                                   </div>

                                   <div class="col-md-6 col-sm-6">
                                        <label for="email">Jam Pencucian</label>
                                        <input type="time" class="form-control" id="email" name="jam_pencucian" min="08:00:00" max="18:00:00" required="">
                                   </div>
                                   ...
                                   <div class="col-md-12 col-sm-12">
                                        <button type="submit" class="form-control" id="cf-submit" name="submit">Booking Sekarang</button>
                                   </div>
                              </div>
                        </form>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="footer-thumb">
                              <div class="opening-hours">
                                   ...
                                   <p>Senin - Minggu <span>07:30 - 18:00</span></p>
                              </div>
                         </div>
                    </div>
